    ...
    with col_left:
        ...
        <div class="left-col-inner">
            <div class="login-logo">
                <span style="margin-right: 8px;">­ƒÅª</span> SafePay
            </div>
        ...
        <div class="login-right-panel">
            <div class="mock-card" style="transform: rotate(-2deg); margin-left: -10%;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                    ...
                    <div style="font-size: 11px; color: #64748B;">This Month Ôîä</div>
                </div>
            ...
            <p>SafePay empowers you with a unified financial command centerÔÇödelivering deep insights and a 360┬░ view of your entire economic world.</p>
